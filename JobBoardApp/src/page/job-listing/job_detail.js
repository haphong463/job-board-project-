                        ...
                        <div className="row justify-content-between">
                            ...
                            <div className="col-xl-7 col-lg-8">
                                <div className="job-title mb-50">
                                    ...
                                    <p className="job-location">
                                        <FaMapMarkerAlt className="icon-location" /> {jobData?.location}
                                    </p>
                                    <p><FaClock className="icon-clock" />{timeAgo}</p>
                            ...
                            <div className="col-xl-4 col-lg-4">
                                <div className="job-overview mb-50">
                                    ...
                                    <ul>
                                        <li>Minimum year of experience: <span>{jobData?.experience}</span></li>
                                ...
                                <div className="company-info mb-51">
                                    ...
                                    <div className="company-detail1">
                                        <a href={companyData?.websiteLink} target="_blank" rel="noopener noreferrer" className="company-link1">
                                            ...
                                            <img className="company-img1" src={companyData?.logo} />
                                    ...
                                    <ul>
                                        ...
                                        <li>Location: <span>{address}</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
